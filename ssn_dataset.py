            ...
            if p+15 <= frame_cnt:
                for i in range(0,16):
                    ...
                    for x in range(self.new_length):
                        frames.extend(self._load_image(prop[0][0], min(frame_cnt, pp+x)))
            else:
                k = frame_cnt-15
                for i in range(0,16):
                    for x in range(self.new_length):
                        frames.extend(self._load_image(prop[0][0], min(frame_cnt, k+x)))
                    k = k+1
            ...
            for idx, seg_ind in enumerate(frame_ticks):
                ...
                if p+15 <= frame_cnt:
                    for i in range(0,16):
                        pp = p+i
                        for x in range(self.new_length):
                            frames.extend(self._load_image(video_id, min(frame_cnt, pp+x)))
                else:
                    k = frame_cnt-15
                    for i in range(0,16):
                        for x in range(self.new_length):
                            frames.extend(self._load_image(video_id, min(frame_cnt, k+x)))
                        k = k+1
                #for x in range(self.new_length):
