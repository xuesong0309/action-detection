...
def runner_func(dataset, state_dict, stats, gpu_id, index_queue, result_queue):
    ...
    net = SSN(num_class, 1, 5, 1,
              args.modality, test_mode=True,
              base_model='p3d', no_regression=args.no_regression, stpp_cfg=stpp_configs)
...
if __name__ == '__main__':
    ...
    dataset = SSNDataSet("", test_prop_file,
                         ...
                         aug_seg=1, body_seg=5,
                         image_tmpl="{:05d}.jpg" if args.modality in ["RGB",
